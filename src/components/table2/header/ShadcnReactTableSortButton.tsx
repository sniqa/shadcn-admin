...
interface ShadcnReactTableSortButtonProps<TData, TValue>
  extends React.HTMLAttributes<HTMLDivElement> {
  column: Column<TData, TValue>;
}

export function ShadcnReactTableSortButton<TData, TValue>({
  column,
  className,
}: ShadcnReactTableSortButtonProps<TData, TValue>) {
    ...
    <div className={cn("flex items-center gap-2", className)}>
      ...
      >
        <SelectTrigger
          ...
          className="h-8 w-fit  border-none text-xs hover:bg-accent hover:text-accent-foreground data-[state=open]:bg-accent [&>svg:last-child]:hidden"
        >
          <SelectIcon asChild>
